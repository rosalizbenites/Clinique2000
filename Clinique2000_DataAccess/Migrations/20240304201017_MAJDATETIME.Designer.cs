...
namespace Clinique2000_DataAccess.Migrations
{
    ...
    [Migration("20240304201017_MAJDATETIME")]
    partial class MAJDATETIME
    {
            ...
            modelBuilder.Entity("Clinique2000_Models.Models.FileDAttente", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = 2,
                            CliniqueId = 1,
                            DateHeureFermeture = new DateTime(2024, 3, 4, 20, 10, 16, 920, DateTimeKind.Local).AddTicks(2641),
                            DateHeureInscriptions = new DateTime(2024, 3, 4, 12, 10, 16, 920, DateTimeKind.Local).AddTicks(2600),
                            DateHeureOuverture = new DateTime(2024, 3, 4, 15, 10, 16, 920, DateTimeKind.Local).AddTicks(2639),
                            EstFermeeManuellement = false,
                            NombreMedecins = 3
                        },
                        new
                        {
                            Id = 3,
                            CliniqueId = 1,
                            DateHeureFermeture = new DateTime(2024, 3, 5, 15, 10, 16, 920, DateTimeKind.Local).AddTicks(2645),
                            DateHeureInscriptions = new DateTime(2024, 3, 5, 12, 10, 16, 920, DateTimeKind.Local).AddTicks(2642),
                            DateHeureOuverture = new DateTime(2024, 3, 5, 15, 10, 16, 920, DateTimeKind.Local).AddTicks(2644),
                            EstFermeeManuellement = false,
                            NombreMedecins = 3
                        },
                        new
                        ...
                        new
                        {
                            Id = 5,
                            CliniqueId = 7,
                            DateHeureFermeture = new DateTime(2024, 3, 4, 20, 10, 16, 920, DateTimeKind.Local).AddTicks(2649),
                            DateHeureInscriptions = new DateTime(2024, 3, 4, 12, 10, 16, 920, DateTimeKind.Local).AddTicks(2647),
                            DateHeureOuverture = new DateTime(2024, 3, 4, 15, 10, 16, 920, DateTimeKind.Local).AddTicks(2648),
                            EstFermeeManuellement = false,
                            NombreMedecins = 3
                        },
                        new
                        {
                            Id = 6,
                            CliniqueId = 7,
                            DateHeureFermeture = new DateTime(2024, 3, 5, 15, 10, 16, 920, DateTimeKind.Local).AddTicks(2653),
                            DateHeureInscriptions = new DateTime(2024, 3, 5, 12, 10, 16, 920, DateTimeKind.Local).AddTicks(2651),
                            DateHeureOuverture = new DateTime(2024, 3, 5, 15, 10, 16, 920, DateTimeKind.Local).AddTicks(2652),
                            EstFermeeManuellement = false,
                            NombreMedecins = 3
                        });
                });
